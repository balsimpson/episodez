<template>
  <div>
    <header class="text-gray-600 body-font">
      <div
        class="container flex items-center justify-between py-5 mx-auto"
      >
        <a
          class="flex items-center mb-4 font-medium text-gray-900 title-font md:mb-0 " href="/"
        >
      ...
      <div class="container px-2 py-24 mx-auto">
        <div class="flex flex-wrap mx-auto">
          ...
          <div class="w-full mt-6 lg:w-1/2 lg:pl-10 lg:py-6 lg:mt-0">
            ...
            <div
              class="flex items-center pb-5 mt-6 mb-5 border-b-2 border-gray-100 "
            >
              <div class="flex">
              ...
              <div class="flex items-center ml-6">
                ...
                <div class="relative">
                  <select
                    class="py-2 pl-3 pr-10 text-base border border-gray-300 rounded appearance-none focus:outline-none focus:ring-2 focus:ring-red-200 focus:border-red-500 "
                  >
                    <option>SM</option>
                    <option>M</option>
                    <option>L</option>
            ...
            <div class="flex">
              <p class="mt-1 text-2xl font-bold md:text-3xl">₹16,000</p>
              <button
                class="flex px-6 py-2 ml-auto font-bold text-white border-0 rounded bg-brand-300 focus:outline-none hover:bg-brand-500"
              >
                Add to cart
              </button>
              <button
    ...
    <!-- related -->
    <div class="container grid gap-2 px-2 mx-auto md:grid-cols-3 ">
      <div class="">
        <div
        ...
        >
          ...
          <div class="p-6">
            ...
            <div class="flex flex-wrap items-center">
              <a class="inline-flex items-center text-red-500 md:mb-2 lg:mb-0"
                >Learn More
                <svg
                  class="w-4 h-4 ml-2"
                  viewBox="0 0 24 24"
      ...
      <div class="">
        ...
        >
          ...
          <div class="p-6">
            ...
            <div class="flex flex-wrap items-center">
              <a class="inline-flex items-center text-brand-300 md:mb-2 lg:mb-0"
                >Learn More
                <svg
                  class="w-4 h-4 ml-2"
                  viewBox="0 0 24 24"
